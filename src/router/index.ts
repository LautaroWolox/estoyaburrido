...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/billetera', name: 'wallet', component: () => import('@/features/wallet/WalletDashboard.vue'), meta: { title: 'Billetera' } },
    { path: '/billetera/tarjetas', name: 'wallet-cards', component: () => import('@/features/wallet/CardsView.vue'), meta: { title: 'Tarjetas' } },
    { path: '/billetera/tarjetas/:id', name: 'wallet-card-detail', component: () => import('@/features/wallet/CardDetailView.vue'), meta: { title: 'Detalle de tarjeta' } },
    { path: '/billetera/sube', name: 'wallet-sube', component: () => import('@/features/wallet/SubeView.vue'), meta: { title: 'SUBE y transporte' } },
    { path: '/billetera/seguridad', name: 'wallet-security', component: () => import('@/features/wallet/WalletSecurityView.vue'), meta: { title: 'Seguridad de billetera' } },
