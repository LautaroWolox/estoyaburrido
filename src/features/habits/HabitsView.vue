...
const form=reactive({title:'',icon:icons[0].value,targetPerWeek:5,color:colors[0]});const days=computed(()=>weekDays());const keys=computed(()=>days.value.map((day)=>format(day,'yyyy-MM-dd')))
